        ...
        <Card>
          <Row>
              ...
              <Table>
                ...
                <Table.Tbody>
                  {this.state.customers.map(customer => (
                    <Table.Tr key={customer.id} onClick={() => {this.chooseActive(customer);}}>
            ...
            <Column>
              ...
              <SelectedCustomer activeCustomer={this.state.activeCustomer}></SelectedCustomer>
            </Column>
          </Row>
        </Card>
      );
              ...
              <Table>
                ...
                <Table.Tbody>
                  ...
                  <Table.Tr>
                    ...
                    <Table.Td>{this.state.customer.streetAddress} {this.state.customer.streetNum}</Table.Td>
                  </Table.Tr>
                  <Table.Tr>
